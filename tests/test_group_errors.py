...
def test_process_update_errors():
	...
	bad_update = GroupUpdate(epoch_id=1, tree=real_update.tree, encrypted_commit_secrets={kem.public_bytes(): b"bad_ciphertext" * 5}, committer_index=0, signature=b"")
	...
	update_parent = GroupUpdate(epoch_id=1, tree=tree_with_parent, encrypted_commit_secrets={kem.public_bytes(): real_update.encrypted_commit_secrets[kem2.public_bytes()]}, committer_index=0, signature=b"")
