...
from pure_mls.group import MLSGroup, GroupSecrets, Welcome, EncryptedGroupSecrets, GroupInfo, GroupContext
from pure_mls.tree import LeafNode, RatchetTree, KeyPackage
from pure_mls.keys import KemKey, SignatureKey
from pure_mls.keyschedule import PreSharedKeyID, PSK_TYPE_EXTERNAL, KeySchedule
...
def test_join_with_psk_real_objects():
    ...
    gi = GroupInfo.build_and_sign(
        group_context=dummy_ctx,
